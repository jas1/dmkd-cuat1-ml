 ...
 *
 */
public class EstrategiaBMuchosChicos {
...
//		System.out.println(sql.length() + " | " +sql2.length());
	...
	public void testUtilsArmaSyntaxGanancia() {
		...
		String[] subfixModelos = { SOLO, SOLO_AGRE, NOR_AGRE, NOR_TARJ, SOLO_DOUB_NO_HIST, SOLO_ESTADO_NO_HIST, SO_INT_N_HIS, SOLO_HIS, NOR_HIST ,SOLO_TARJ};
//		String[] subfixModelos = { SOLO, SOLO_AGRE, NOR_AGRE, NOR_TARJ, SOLO_DOUB_NO_HIST, SOLO_ESTADO_NO_HIST, SO_INT_N_HIS, SOLO_HIS, NOR_HIST ,SOLO_TARJ};
//		String[] subfixModelos = { SOLO, SOLO_AGRE, NOR_AGRE, NOR_TARJ, SOLO_DOUB_NO_HIST, SOLO_ESTADO_NO_HIST, SO_INT_N_HIS, SOLO_HIS, NOR_HIST };
		String[] paramsModelos = { "CHAID_7_300_65_101723", "CHAID_7_300_65_208403", "CHAID_7_300_65_663552", "CHAID_7_300_65_826668", "CHAID_7_300_65_980641" };
		String[] prefixCols = { prefixColProba, prefixColGanancia, prefixColNodo, prefixColTrain };
		// tipo modelos > modelos > tipo var > var
...
//		con normalizador de 0.3
	 ...
	 * aplicar los modelos en otros meses porque abril lo estoy usando, 
	 * probar marzo, probar enero, probar junio.
	 * 
	 */
	@Test
...
//		 lo que va diferente en la persistencia es que varia lac antidad de columnas el resto me parece que sigue igual entonces lo que hay que tunear es el arma nombres
